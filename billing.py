...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed By Pankaj")
        ...
        #ProductFrame1.place(x=6,y=110,width=410,height=670)
        ...
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times new roman",15),bg="lightyellow").place(x=128,y=50,width=150,height=22)
        btn_search=Button(ProductFrame2,text="Search",command=self.search,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=285,y=48,width=100,height=25)
        ...
        #ProductFrame3.place(x=2,y=140,width=398,height=490)
        ProductFrame3.place(x=2,y=140,width=398,height=440)
        ...
        CustomerFrame.place(x=420,y=110,width=585,height=77)  

        cTitle=Label(CustomerFrame,text="Customer Details",font=("goudy old style",15,"bold"),bg="#0AC109").pack(side=TOP,fill=X)
        lbl_name=Label(CustomerFrame,text="Name",font=("times new roman",15),bg="white").place(x=10,y=35)
        ...
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times new roman",15),bg="lightyellow").place(x=380,y=35,width=150)

        #=====Calculator Cart Frame====
        Cal_Cart_Frame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        Cal_Cart_Frame.place(x=420,y=210,width=585,height=360)  
        ...
        cart_Frame.place(x=280,y=8,width=300,height=342)
        ...
        Add_CartWidgetsFrame.place(x=420,y=580,width=585,height=130)
        ...
        lbl_p_price=Label(Add_CartWidgetsFrame,text="Price Per Qty",font=("times new roman",15,"bold"),bg="white").place(x=230,y=5)
        ...
        lbl_p_qty=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15,"bold"),bg="white").place(x=450,y=5)
        txt_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow").place(x=425,y=35,width=120,height=22)
  
        self.lbl_inStock=Label(Add_CartWidgetsFrame,text="In Stock",font=("times new roman",15,"bold"),bg="white")
        self.lbl_inStock.place(x=5,y=70)

        btn_clear_cart=Button(Add_CartWidgetsFrame,text="Clear",command=self.clear_cart,font=("times new roman",18,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=32)
        btn_add_cart=Button(Add_CartWidgetsFrame,text="Add | Update Cart",command=self.add_update_cart,font=("times new roman",18,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=200,height=32)


#================billing area=============================

        billFrame=Frame(self.root,bd=2,relief=RIDGE,bg='white')
        billFrame.place(x=1010,y=110,width=510,height=410)

        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#184a45",fg="white").pack(side=TOP,fill=X)
...
#================billing Buttons=============================
        ...
        billMenuFrame.place(x=1010,y=520,width=510,height=215)

        self.lbl_amnt=Label(billMenuFrame,text='Bill Amount\n[0]',font=("goudy old style",15,"bold"),bg="#3f51b5",fg="white")
        self.lbl_amnt.place(x=2,y=5,width=157,height=100)

        self.lbl_discount=Label(billMenuFrame,text='Discount \n[5%]',font=("goudy old style",15,"bold"),bg="#8bc34a",fg="white")
        self.lbl_discount.place(x=165,y=5,width=157,height=100)

        self.lbl_net_pay=Label(billMenuFrame,text='Net Pay\n[0]',font=("goudy old style",15,"bold"),bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=328,y=5,width=157,height=100)
        ...
        btn_print.place(x=2,y=110,width=157,height=90)
        ...
        btn_clear_all.place(x=165,y=110,width=157,height=90)
        ...
        btn_generate.place(x=328,y=110,width=157,height=90)


        #===============Footer=================
        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Pankaj Baviskar",font=("times new roman",18),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#=================All Functions==============================
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\t\tSwami General Store
\t Phone No. 9872545323 , Jalgaon-425001
{str("="*57)}
