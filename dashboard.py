...
class IMS:
    def __init__(self,root):
        ...
        #LeftMenu.place(x=0,y=110,width=250,height=565)
        LeftMenu.place(x=0,y=110,width=300,height=650)

        lbl_menuLogo=Label(LeftMenu,image=self.MenuLogo)
        lbl_menuLogo.pack(side=TOP,fill=X)

        self.icon_side=PhotoImage(file="images/side.png")
        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",25),bg="#009688").pack(side=TOP,fill=X)
        ...
        #==content==
        self.lbl_employee=Label(self.root,text="Total Employee\n[ 0 ]",bd=5,relief=RIDGE,bg="#009CC8",fg="white",font=("goudy old style",25,"bold"))
        #self.lbl_employee.place(x=300,y=120,height=150,width=300)
        self.lbl_employee.place(x=350,y=150,height=200,width=350)

        self.lbl_supplier=Label(self.root,text="Total Supplier\n[ 0 ]",bd=5,relief=RIDGE,bg="#ff5722",fg="white",font=("goudy old style",25,"bold"))
        #self.lbl_supplier.place(x=650,y=120,height=150,width=300)
        self.lbl_supplier.place(x=750,y=150,height=200,width=350)

        self.lbl_category=Label(self.root,text="Total Category\n[ 0 ]",bd=5,relief=RIDGE,bg="#009688",fg="white",font=("goudy old style",25,"bold"))
        #self.lbl_category.place(x=1000,y=120,height=150,width=300)
        self.lbl_category.place(x=1150,y=150,height=200,width=350)

        self.lbl_product=Label(self.root,text="Total Product\n[ 0 ]",bd=5,relief=RIDGE,bg="#607d8b",fg="white",font=("goudy old style",25,"bold"))
        #self.lbl_product.place(x=300,y=300,height=150,width=300)
        self.lbl_product.place(x=550,y=400,height=200,width=350)

        self.lbl_sales=Label(self.root,text="Total Sales\n[ 0 ]",bd=5,relief=RIDGE,bg="#0EB92F",fg="white",font=("goudy old style",25,"bold"))
        #self.lbl_sales.place(x=650,y=300,height=150,width=300)
        self.lbl_sales.place(x=950,y=400,height=200,width=350)

        #==footer==
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed By Pankaj Baviskar\nFor any Technical Issue Email : baviskarpankaj1998@gmail.com ",font=("times new roman",18),bg="#175C7D",fg="white").pack(side=BOTTOM,fill=X)
