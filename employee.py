...
class employeeClass:
    def __init__(self,root):
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",18),bg="#4caf50",fg="white",cursor="hand2").place(x=430,y=9,width=150,height=30)

        #===title===
        title=Label(self.root,text="Employee Details",font=("goudy old style",20),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1130)
        ...
        #==buttons==
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",18),bg="#2196f3",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=30)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",18),bg="#4caf50",fg="white",cursor="hand2").place(x=620,y=305,width=110,height=30)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",18),bg="#f44336",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=30)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",18),bg="#607d8b",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=30)
        ...
        self.EmployeeTable.column("doj",width=40)
        self.EmployeeTable.column("pass",width=60) 
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This Employee ID alreday assigned, try different",parent=self.root)
                else:
