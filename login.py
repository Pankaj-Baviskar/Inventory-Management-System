...
from matplotlib.pyplot import title  #pip install pillow
...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By Pankaj Baviskar")
        #self.root.geometry("1520x790+0+0")
        self.root.geometry("900x700+300+30")
        self.root.config(bg="#fafafa")

        self.otp=''

        #=========Title ==========
        title=Label(self.root,text="Inventory Management System",font=("goudy old style",25,"bold"),bg="#19739F",fg="white").place(x=50,y=10,width=800,height=40)


        #=========images===========
        self.phone_image=ImageTk.PhotoImage(file="images/phone.png")
        #self.lbl_Phone_image=Label(self.root,image=self.phone_image,bd=0).place(x=200,y=50)
        self.lbl_Phone_image=Label(self.root,image=self.phone_image,bd=0).place(x=20,y=50)
        ...
        login_frame.place(x=470,y=120,width=350,height=460)

        title=Label(login_frame,text="Login",font=("Elephant",30,"bold"),bg="white").place(x=0,y=30,relwidth=1)
        
        lbl_user=Label(login_frame,text="Employee / Admin ID",font=("Andalus",15,"bold"),bg="white",fg="#767171").place(x=50,y=100)
        self.employee_id=StringVar()
        self.password=StringVar()        
        ...
        lbl_pass=Label(login_frame,text="Password",font=("Andalus",15,"bold"),bg="white",fg="#767171").place(x=50,y=200)
        txt_pass=Entry(login_frame,textvariable=self.password,show="*",font=("times new roman",15),bg="#ECECEC").place(x=50,y=240,width=250)

        btn_login=Button(login_frame,command=self.login,text="Log In",font=("Arial Rounded MT Bold",15),cursor="hand2",bg="#00B0F0",activebackground="#00B0F0",fg="white",activeforeground="white").place(x=50,y=300,width=250,height=35)

        hr=Label(login_frame,bg="lightgray").place(x=50,y=370,width=250,height=2)
        or_=Label(login_frame,text="OR",bg="white",fg="lightgray",font=("times new roman",15,"bold")).place(x=150,y=355)

        btn_forget=Button(login_frame,text="Forget Password?",cursor="hand2",command=self.forget_window,font=("times new roman",15),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=100,y=390)
        ...
        self.lbl_change_image.place(x=187,y=153,width=240,height=428)


        self.animate()

         #==footer==
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed By Pankaj Baviskar",font=("times new roman",20),bg="#1682EB",fg="white").pack(side=BOTTOM,fill=X)
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    if chk=='f':
                        ...
                        self.forget_win.geometry('400x350+600+150')
                        ...
                        self.btn_update=Button(self.forget_win,text="Update Password",command=self.update_password,state=DISABLED,font=("times new roman",15),bg='lightblue')
                        self.btn_update.place(x=130,y=300,width=160,height=30)
