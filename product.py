...
class productClass:
    def __init__(self,root):
        ...
        #self.root.geometry("width x height + 220 + 130")
        ...
        lbl_productname=Label(product_Frame,text="Name",font=("goudy old style",18),bg="white").place(x=30,y=160)
        ...
        txt_search=Entry(searchFrame,textvariable=self.var_searchtxt,font=("goudy old style",18),bg="lightyellow").place(x=230,y=10)
        btn_search=Button(searchFrame,text="Search",command=self.search,font=("goudy old style",18),bg="#4caf50",fg="white",cursor="hand2").place(x=510,y=9,width=150,height=30)

         #######Product Details==========

        p_frame=Frame(self.root,bd=3,relief=RIDGE)
        p_frame.place(x=480,y=100,width=700,height=480)
        ...
        self.product_table.column("Category",width=70)
